...
<body class="login-container">
    ...
    <main class="login-section">
        <div class="login-form-wrapper" style="max-width: 600px;">
            <div class="login-header">
                <h2>Create Account 👋</h2>
                <p>Register as a Teacher or Department Initiator — RP Evaluation</p>
            </div>

            <form action="<c:url value='/register'/>" method="post" style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
