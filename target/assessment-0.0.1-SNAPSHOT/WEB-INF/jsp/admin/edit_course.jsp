...
<head>
    ...
    <title>Edit Course | RP Admin</title>
    ...
    <div class="dashboard-container">
        <div class="header-row">
            <div>
                ...
                <h1 style="margin-top: 0.5rem;">Edit Course</h1>
                <p style="color: var(--text-muted);">Update course information and assignments.</p>
            </div>
        </div>

        <div class="glass fade-up">
            <h2 style="padding: 2rem; border-bottom: 1px solid var(--glass-border);">Course Details</h2>
            <div style="padding: 2rem;">
                <form action="<c:url value='/admin/courses/update/${course.id}'/>" method="post">
                    ...
                    <div style="margin-top: 3rem; display: flex; gap: 1rem; justify-content: flex-end;">
                        <a href="<c:url value='/admin/courses'/>" class="btn btn-secondary">
        ...
        <div class="glass fade-up" style="margin-top: 2rem;">
            ...
            <div style="padding: 2rem;">
                <div style="display: flex; align-items: center; gap: 2rem;">
                    <div style="flex: 1;">
                        <h3 style="color: #ef4444; margin-bottom: 0.5rem;">Delete Course</h3>
                        <p style="color: var(--text-muted); font-size: 0.9rem;">Once you delete a course, there is no going back. Please be certain.</p>
                    </div>
                    <form action="<c:url value='/admin/courses/delete/${course.id}'/>" method="post" style="display: inline;">
                        <button type="submit" class="btn" style="background: #ef4444; color: white;" onclick="return confirm('Are you sure you want to delete this course? This action cannot be undone.')">
